...
<nav
	class="col navbar navbar-expand-lg sticky-top navbar-light bg-light"
	style="padding: 20px;">
		...
		<ul class="navbar-nav mr-auto">
			...
			<c:if test="${not empty account}">
				...
				<c:if test="${account.isAdmin == 0}">
					<li class="nav-item active"><a class="nav-link"
						href="<c:url value="/admin/post"/>">Quản lý bài viết</a></li>
					<li class="nav-item active"><a class="nav-link"
						href="<c:url value="/admin/user"/>">Quản lý người dùng</a></li>
				</c:if>
			</c:if>
		</ul>
